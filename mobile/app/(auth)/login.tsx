      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1 px-8 pt-20 pb-10">
          ...
          <View className="mb-12">
            <Text className="text-4xl font-bold text-slate-900 mb-2">FocusMind AI</Text>
            <Text className="text-slate-500 text-lg">Welcome back! Please login to continue.</Text>
          </View>
          ...
          <View className="space-y-6">
            ...
            <TouchableOpacity
              onPress={handleLogin}
              disabled={loading}
              className="bg-primary-600 rounded-2xl py-4 items-center shadow-lg shadow-primary-500/30"
            >
              {loading ? (
